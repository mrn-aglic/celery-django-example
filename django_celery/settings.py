...
SECRET_KEY = 'django-insecure-wahw%+zkca9r@a^np^_y)8zqmy$2_s8@c&(uf2-qxu&&zd5&!c'
...
CELERY_BEAT_SCHEDULE = {
    'add_every_10_seconds': {
        'task': 'tasksapp.tasks.add',
        'schedule': 10.0,  # Run every 10 seconds
        'args': (16, 16),
    },
    'multiply_every_15_seconds': {
        'task': 'tasksapp.tasks.multiply',
        'schedule': 15.0,  # Run every 15 seconds
        'args': (4, 5),
    },
    'generate_random_number_every_20_seconds': {
        'task': 'tasksapp.tasks.random_number_generator',
